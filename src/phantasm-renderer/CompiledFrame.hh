...
public:
    ...
    CompiledFrame(CompiledFrame&& rhs) noexcept
      : _valid(rhs._valid),
        ...
        _cache_free_resources(cc::move(rhs._cache_free_resources)),
...
private:
    ...
    CompiledFrame(phi::handle::command_list cmdlist,
      ...
      : _valid(true),
        ...
        _cache_free_resources(cc::move(deferred_cache_free_resources)),
    ...
    cc::alloc_vector<phi::handle::resource> _cache_free_resources;
