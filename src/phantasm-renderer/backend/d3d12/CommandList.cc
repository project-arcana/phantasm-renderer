                                                     ...
                                                     D3D12_COMMAND_LIST_TYPE type)
{
    ...
    for (auto& ring_entry : mRing)
    {
        ...
        PR_D3D12_VERIFY(device.CreateCommandAllocator(type, PR_COM_WRITE(ring_entry.command_allocator)));
        ...
        {
            PR_D3D12_VERIFY(device.CreateCommandList(0, type, ring_entry.command_allocator, nullptr, PR_COM_WRITE(list)));
            list->Close();
        }
