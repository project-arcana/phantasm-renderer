...
namespace
{
void populate_srv(phi::resource_view& new_rv, pr::image const& img)
{
...
void populate_uav(phi::resource_view& new_rv, pr::image const& img)
{
    new_rv.resource = img._resource.data.handle;
...
void pr::persistent_argument::add(const pr::image& img)
{
...
void pr::persistent_argument::add(const pr::buffer& buffer)
{
...
void pr::persistent_argument::add(const pr::render_target& rt)
{
...
void pr::persistent_argument::add_mutable(const pr::image& img)
{
    _resource_guids.push_back(img._resource.data.guid);
...
void pr::persistent_argument::add_mutable(const pr::buffer& buffer)
{
    _resource_guids.push_back(buffer._resource.data.guid);
...
void pr::persistent_argument::add_mutable(const pr::render_target& rt)
{
    _resource_guids.push_back(rt._resource.data.guid);
